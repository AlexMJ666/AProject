...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/AlexMJ666/AProject"
  ...
  s.source       = { :git => "https://github.com/AlexMJ666/AProject.git", :tag => s.version.to_s }
  ...
  s.source_files  = "AProject/AProject/**/*.{h,m}"
